...
const Input = styled.input`
  width: 100%;
  padding: 0.9rem 1rem 0.9rem 2.8rem; /* extra left padding for icon */
  background: #FFFFFF;
    ...
    <RegisterContainer>
      <RegisterCard>
        <RegisterHeader>
          ...
          <RegisterSubtitle>Join our library community</RegisterSubtitle>
        </RegisterHeader>
        ...
        <LinkButton to="/login"><span>Already have an account ?</span> Sign In</LinkButton>
