    ...
    <LoginContainer>
      <LoginCard>
        ...
        <div style={{ textAlign: 'center', marginTop: '1rem' }}>
          <Link to="/reset-password" style={{ color: '#3e6d4a', fontSize: '0.9rem', textDecoration: 'underline' }}>
        ...
        <LinkButton to="/register"><span>Don't have an account?</span> Create Account</LinkButton>
